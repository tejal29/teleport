...
your cluster, e.g., when a user logs in to a Teleport cluster, the Auth Service
issues a certificate, or an operator creates a role. 
...
Next, read our guides to setting up the Event Handler plugin to export audit events to
